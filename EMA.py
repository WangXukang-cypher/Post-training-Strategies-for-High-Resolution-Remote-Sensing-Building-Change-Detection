# 运行方式示例：
# python retrain_other.py --data_root /fast/Wang/Chaofen/Smashiki_256QuaterCD --save_path /fast/Wang/Chaofen/S128exp/WHU-CD_iter_200000_lr_0.0002/retrained_other_best.pth
#
# 与 retrain.py 数据读取/预处理保持一致，但改用“EMA Teacher 一致性 + KL 保护”的后训练方案，
# 去掉 DPO，加入教师软标签一致性，训练更平滑、保守。
